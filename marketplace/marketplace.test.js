...
test("marketplace archive has static Bitrix24 entry files", () => {
  ...
  assert.match(settingsHtml, /settings\.js\?v=layout-20260814-3/);
  assert.match(settingsHtml, /style\.css\?v=layout-20260814-3/);
  assert.match(indexHtml, /app\.js\?v=layout-20260814-3/);
  assert.match(indexHtml, /style\.css\?v=layout-20260814-3/);
  assert.match(workerHtml, /worker\.js\?v=layout-20260814-3/);
  assert.match(indexHtml, /Deal Invoice Summary v\.21 Marketplace B24/);
...
test("marketplace app uses Bitrix24 REST directly without VibeCode backend", () => {
  ...
  assert.match(appJs, /Сопоставление доступно только администратору CRM/);
  ...
  assert.match(appJs, /layout-20260814-3/);
  assert.match(appJs, /Deal Invoice Summary v\.21 Marketplace B24/);
...
test("marketplace background worker watches open deal pages without backend", () => {
  assert.match(workerJs, /layout-20260814-3/);
  assert.match(workerJs, /Deal Invoice Summary v\.21 Marketplace B24/);
...
test("marketplace automation panel presents mass recalculation and statistics", () => {
  ...
  assert.match(appJs, /function estimateCalculationMinutes/);
  ...
  assert.match(styleCss, /\.form-actions\s*{[\s\S]*min-height:\s*88px/);
