...
const appVersion = "layout-20260810-10";
...
const serverSupportModeDetails = {
  continuous: 'Режим "Постоянный" - сервер будет просыпаться каждые 2 часа с 8:30 до 20:30, с таймером сна в 15 мин после пробуждения. Интервал пересчёта - дважды после пробуждения, т.е. каждые 7 мин. Расписание: 08:30, 10:30, 12:30, 14:30, 16:30, 18:30, 20:30. За сутки время работы сервера составит 1 час 45 минут. Для micro-сервера это примерно 164,2 Ꝟ за 30 рабочих дней.',
  twiceDaily: 'Режим "Утром и вечером" - сервер будет включаться в заданное время утром и вечером, всего два раза в сутки, с таймером сна в 15 мин после каждого пробуждения. Интервал пересчёта - дважды после пробуждения, т.е. каждые 7 мин. Расписание: 09:44, 18:44. За сутки время работы сервера составит 30 минут. Для micro-сервера это примерно 139,8 Ꝟ за 30 рабочих дней.',
};
